...
class UmkmController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'logo' => 'nullable|image|mimes:jpeg,png,jpg|max:2048', // Tambahkan validasi logo
            'jenis_usaha_id' => 'required|exists:kategori_jenis_usaha,id', // Diperbaiki: Nama tabel jenis usaha
